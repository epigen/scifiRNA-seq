...
echo "echo 'r2,read,unique_umi,umi,gene,unique_fraction' > header1" >> $JOB
...
echo "echo 'r2,gene,umi' > header2" >> $JOB
...
echo "echo 'r2,read,unique_umi,umi,gene,unique_fraction' > header3" >> $JOB
...
echo "echo 'r2,gene,umi' > header4" >> $JOB
